...
switch(N),
    ...
    case 2,
        ...
        canwri('LogSkip',1000);
        canwri('LogAddr0',getaddr('isrCountF'));
        canwri('LogAddr1',getaddr('nullStepF'));
        canwri('LogInit',1);
    case 3,
    ...
    case 7,
        ...
        canwri('LogAddr5',getaddr('ThetaOut'));
        canwri('LogAddr6',getaddr('VdRef'));
        canwri('LogAddr7',getaddr('VqRef'));
        canwri('LogAddr8',getaddr('EncoderOffset'));
        canwri('LogInit',1);
    case 8,
        canwri('LogSingle',1);
        canwri('LogChan',9);
...
%        canwri('LogAddr8',getaddr('WeError'));
    ...
    case 15,
        ...
        canwri('LogAddr2',getaddr('ResExc'));
        canwri('LogInit',1);
    case 16,
        canwri('LogSingle',1);
        canwri('LogChan',3);
...
%        canwri('LogAddr8',getaddr('ResOmega'));
    ...
    case 24,
        ...
        canwri('LogAddr4',getaddr('Iq'));
        canwri('LogAddr5',getaddr('We'));
        canwri('LogAddr6',getaddr('Vtotal'));
%        canwri('LogAddr6',getaddr('In'));
        canwri('LogAddr7',getaddr('Vs8500'));
%        canwri('LogAddr8',getaddr('In'));
%        canwri('LogAddr8',getaddr('ThetaOut'));
%        canwri('LogAddr8',getaddr('WeError'));
        canwri('LogAddr8',getaddr('IdFw'));
        canwri('LogInit',1);
    case 25,
        canwri('LogSingle',1);
        canwri('LogChan',9);
        ...
        canwri('LogAddr0',getaddr('IdRef'));
        canwri('LogAddr1',getaddr('IqRef'));
        canwri('LogAddr2',getaddr('RpmRef'));
        canwri('LogAddr3',getaddr('Id'));
        canwri('LogAddr4',getaddr('Iq'));
        canwri('LogAddr5',getaddr('RpmOut'));
        canwri('LogAddr6',getaddr('VdRef'));
        canwri('LogAddr7',getaddr('VqRef'));
%        canwri('LogAddr8',getaddr('ThetaOut'));
        canwri('LogAddr8',getaddr('Vbus'));
